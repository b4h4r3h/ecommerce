...
const FirstBanner: React.FC = () => {
    return (
        <Link to="" className="bg-[#ffe0d0] flex items-center h-[416px] px-10 justify-between mt-6 rounded-xl shadow-buttonShadow">
            ...
            <div className="flex flex-col gap-6">
                ...
                {/* <div > */}
                    <div className="flex items-center gap-2 bg-white px-4 py-2 w-fit shadow-buttonShadow rounded-md" >
