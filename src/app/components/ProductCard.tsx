...
const ProductCard: React.FC<{
  ...
  const dispatch = useDispatch()
    ...
    return (
      <Link to={`/products/${id}`} className='block p-4 border-2 border-text-dark rounded-xl shadow-buttonShadow hover:shadow-lightShadow hover:translate-x-1 hover:translate-y-1 bg-white'>
